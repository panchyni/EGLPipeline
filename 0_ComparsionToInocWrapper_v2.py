...
# -Added main function so this script can be used a module
# -Imputation of Innoculum sample based on bootstraping SNPs sites if only 1 Inncolumn is available
